...
| [OpenBLAS](https://github.com/OpenMathLib/OpenBLAS) | v0.3.28 | BSD-3-Clause | Zhang Xianyi et al. |
...
| [replxx](https://github.com/AmokHuginnsson/replxx) | release-0.0.4 | BSD-3-Clause | Marcin Konarski, Salvatore Sanfilippo, Pieter Noordhuis | `ETIL_BUILD_EXAMPLES` |
...
|---------|---------|-------|
| [LLVM](https://llvm.org/) | Apache-2.0 with LLVM Exception | Always required (JIT infrastructure) |
