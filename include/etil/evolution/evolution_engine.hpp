...
struct EvolutionConfig {
    ...
    size_t instruction_budget = 100000;  // max instructions per fitness eval

    // Type Bridge Back Propagation (TBBP)
    bool tbbp_enabled = true;             // adaptive bridge weight learning
    ...
    size_t dag_stats_interval = 0;   // 0 = end-only, >0 = log stats every N generations
