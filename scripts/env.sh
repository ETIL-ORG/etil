...
ETIL_CMAKE_COMMON_FLAGS="-DETIL_BUILD_HTTP_CLIENT=ON -DETIL_BUILD_JWT=ON -DETIL_BUILD_MONGODB=ON -DETIL_BUILD_NATS_SINK=ON -DCMAKE_EXPORT_COMPILE_COMMANDS=ON"
